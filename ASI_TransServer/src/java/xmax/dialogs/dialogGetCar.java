...
public class dialogGetCar extends JDialog {
   ...
   ***********************************************************************
   */
  public dialogGetCar(final Frame aOwner, final String aCrsCode)
    {
    super(aOwner, "", true);
    ...
    this.setTitle("Get " + sHostName + " Car Rental Information");
  ...
  private void jbInit() throws Exception
    ...
    btnOK.setText("OK");
    btnOK.addActionListener(new dialogGetCar_btnOK_actionAdapter(this));
    btnCancel.setText("Cancel");
    gridLayout1.setHgap(4);
    btnCancel.addActionListener(new dialogGetCar_btnCancel_actionAdapter(this));
  ...
  /*
  public ReqGetCarInfo getRequest()
    {
    final ReqGetCarInfo request = new ReqGetCarInfo(CrsCode,getCompanyCode(),getLocationCode(),getCityCode());
    return(request);
    }
  */
  ...
  public static void main(String[] args)
    ...
    try
      {
      final dialogGetCar dlg = new dialogGetCar(null,"AA");

      dlg.show();
      if ( dlg.isValidData )
        {
     //   final ReqGetCarInfo request  = dlg.getRequest();

        JOptionPane.showMessageDialog(null,"You selected car info for company " + dlg.getCompanyCode() + " location " + dlg.getLocationCode() + " city " + dlg.getCityCode());
        }
 ...
 ***********************************************************************
 */
class dialogGetCar_btnOK_actionAdapter implements ActionListener
{
 private dialogGetCar owner;

 // constructor
 dialogGetCar_btnOK_actionAdapter(final dialogGetCar aOwner)
   {
   owner = aOwner;
   }
 ...
 ***********************************************************************
 */
class dialogGetCar_btnCancel_actionAdapter implements ActionListener
{
 private dialogGetCar owner;

 // constructor
 dialogGetCar_btnCancel_actionAdapter(final dialogGetCar aOwner)
   {
   owner = aOwner;
   }
