...
**/
public class NegotiatedSpaceInformationDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public NegotiatedSpaceInformationDescriptor() {
        super();
        xmlName = "negotiatedSpaceInformation";
        ...
        handler = (new XMLFieldHandler() {
            ...
            {
                NegotiatedSpaceInformation target = (NegotiatedSpaceInformation) object;
    ...
    } //-- xmax.crs.Amadeus.negospace.NegotiatedSpaceInformationDescriptor()
    ...
    **/
    ...
    {
        return xmax.crs.Amadeus.negospace.NegotiatedSpaceInformation.class;
