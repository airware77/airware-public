...
/**
 * 
 * @version $Revision: 1$ $Date: 02/08/2002 8:17:22 PM$
**/
public class NegotiatedSpaceInformation implements java.io.Serializable {
    ...
    public NegotiatedSpaceInformation() {
        super();
        _linkedNegotiatedSpaceListList = new ArrayList();
    } //-- xmax.crs.Amadeus.negospace.NegotiatedSpaceInformation()
    ...
    **/
     ...
     * @param reader
    **/
    public static xmax.crs.Amadeus.negospace.NegotiatedSpaceInformation unmarshalNegotiatedSpaceInformation(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (xmax.crs.Amadeus.negospace.NegotiatedSpaceInformation) Unmarshaller.unmarshal(xmax.crs.Amadeus.negospace.NegotiatedSpaceInformation.class, reader);
    } //-- xmax.crs.Amadeus.negospace.NegotiatedSpaceInformation unmarshalNegotiatedSpaceInformation(java.io.Reader) 
