...
**/
public class PoweredAir_CancelNegoSpaceDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public PoweredAir_CancelNegoSpaceDescriptor() {
        super();
        xmlName = "PoweredAir_CancelNegoSpace";
        ...
        handler = (new XMLFieldHandler() {
            ...
            {
                PoweredAir_CancelNegoSpace target = (PoweredAir_CancelNegoSpace) object;
    ...
    } //-- xmax.crs.Amadeus.negospace.PoweredAir_CancelNegoSpaceDescriptor()
    ...
    **/
    ...
    {
        return xmax.crs.Amadeus.negospace.PoweredAir_CancelNegoSpace.class;
