...
**/
public class PoweredAir_CancelNegoSpace implements java.io.Serializable {
    ...
    public PoweredAir_CancelNegoSpace() {
        super();
        _negotiatedSpaceInfoList = new ArrayList();
    } //-- xmax.crs.Amadeus.negospace.PoweredAir_CancelNegoSpace()
    ...
    **/
     ...
     * @param reader
    **/
    public static xmax.crs.Amadeus.negospace.PoweredAir_CancelNegoSpace unmarshalPoweredAir_CancelNegoSpace(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (xmax.crs.Amadeus.negospace.PoweredAir_CancelNegoSpace) Unmarshaller.unmarshal(xmax.crs.Amadeus.negospace.PoweredAir_CancelNegoSpace.class, reader);
    } //-- xmax.crs.Amadeus.negospace.PoweredAir_CancelNegoSpace unmarshalPoweredAir_CancelNegoSpace(java.io.Reader) 
