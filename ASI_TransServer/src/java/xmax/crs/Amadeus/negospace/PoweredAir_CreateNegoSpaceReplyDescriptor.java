...
**/
public class PoweredAir_CreateNegoSpaceReplyDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public PoweredAir_CreateNegoSpaceReplyDescriptor() {
        super();
        xmlName = "PoweredAir_CreateNegoSpaceReply";
        ...
        handler = (new XMLFieldHandler() {
            ...
            {
                PoweredAir_CreateNegoSpaceReply target = (PoweredAir_CreateNegoSpaceReply) object;
    ...
    } //-- xmax.crs.Amadeus.negospace.PoweredAir_CreateNegoSpaceReplyDescriptor()
    ...
    **/
    ...
    {
        return xmax.crs.Amadeus.negospace.PoweredAir_CreateNegoSpaceReply.class;
