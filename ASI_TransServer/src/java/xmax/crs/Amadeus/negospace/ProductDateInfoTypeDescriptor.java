...
/**
 * 
 * @version $Revision: 3$ $Date: 02/25/2002 6:48:47 PM$
**/
public class ProductDateInfoTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ProductDateInfoTypeDescriptor() {
        super();
        xmlName = "ProductDateInfoType";
        ...
        handler = (new XMLFieldHandler() {
            ...
            {
                ProductDateInfoType target = (ProductDateInfoType) object;
    ...
    } //-- xmax.crs.Amadeus.negospace.ProductDateInfoTypeDescriptor()
    ...
    **/
    ...
    {
        return xmax.crs.Amadeus.negospace.ProductDateInfoType.class;
